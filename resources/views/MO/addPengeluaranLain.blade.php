        ...
        <main>
            <div class="row" style="margin-top: 80px">
                <div class="col-5 title2">
                    <h1 style="font-weight: 800">Pengeluaran Lain</h1>
                    <p style="font-size: 25px; font-weight: 200;">Hi MO, Welcome in Data Pengeluaran!</p>
                </div>
                <div class="col-7">
                    <div class="profile">
            ...
            <div class="container mt-4 mb-5">
                <div class="row">
                    <div class="title mt-5 mb-5">
                        <h5 style="font-size: 40px; font-weight: 600;">Data Pengeluaran</h5>
                    </div>

                    <form action="{{ route('store_PencatatanPengeluaranLain') }}" method="POST">
                        @csrf
                        ...
                        <div class="body-input">
                            <div class="col-6">
                                ...
                                <div class="label mt-3">
                                    <p class="mb-0">Harga Pengeluaran</p>

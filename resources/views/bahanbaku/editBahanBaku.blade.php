                        ...
                        <form action="{{ route('bahanbaku.update', $bahanbaku->id) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select id="bahan_baku_id"
                                    ...
                                    @foreach ($bb as $b)
                                        @if ($b->id == old('bahan_baku_id', $bahanbaku))

                                            <option value="{{ $b->id }}" selected>{{ $b->nama_bahan_baku }}
                                            </option>
                                        @else
                                ...
                                <!-- error message untuk bahan_baku_id -->
                                @error('bahan_baku_id')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <!-- <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    ...
                                    @foreach ($bb as $b )
                                    <option value="{{$b->id}}" {{ $b->id == old('satuan', $bahanbaku) ? 'selected' : '' }}>{{$b->satuan_bahan_baku}}</option>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('jumlah') is-invalid @enderror"
                                    name="jumlah" value="{{ $bahanbaku->jumlah }}" placeholder="Masukkan jumlah">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('harga') is-invalid @enderror"
                                    name="harga" value="{{ $bahanbaku->harga }}" placeholder="Masukkan Harga">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            name="tanggal_pembelian" value="{{ $bahanbaku->tanggal_pembelian }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            name="tanggal_kadaluarsa" value="{{ $bahanbaku->tanggal_kadaluarsa }}"

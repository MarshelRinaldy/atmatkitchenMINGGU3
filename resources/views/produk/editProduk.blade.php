            ...
            <div class="col-md-10">
                <div class="card border-0 shadow-lg my-4">
                    <div class="card-header bg-dark">
                        <h3 class="text-white">Edit Produk</h3>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input value="{{ old('nama_produk',$produk->nama_produk) }}" type="text" class=" @error('nama_produk') is-invalid @enderror form-control form-control-lg" placeholder="Nama Produk" name="nama_produk">
                            @error('nama_produk')
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('harga_produk',$produk->harga_produk) }}" type="text" class=" @error('harga_produk') is-invalid @enderror form-control form-control-lg" placeholder="Harga Produk" name="harga_produk">
                            @error('harga_produk')
                                <p class="invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input value="{{ old('stok_produk',$produk->stok_produk) }}" type="text" class=" @error('stok_produk') is-invalid @enderror form-control form-control-lg" placeholder="Stok Produk" name="stok_produk">
                            @error('stok_produk')
                                <p class="invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class=" @error('deskripsi_produk') is-invalid @enderror form-control form-control-lg" name="deskripsi_produk" cols="30" rows="5" placeholder="Deskripsi Produk">{{ old('deskripsi_produk',$produk->deskripsi_produk) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            @if($produk->image != "")
                                <img class="w-50 my-3" src = "{{asset('uploads/produk'.$produk->image)}}" alt="gambar">
                            @endif
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label h4">Kategori Produk</label>
                            <input value="{{ old('kategori_produk',$produk->kategori_produk)}}" type="text" class=" @error('kategori_produk') is-invalid @enderror form-control form-control-lg" name="kategori_produk" placeholder="Kategori Produk">

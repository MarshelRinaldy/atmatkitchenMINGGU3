        ...
        <main>
            <div class="row" style="margin-top: 80px">
                <div class="col-5 title2">
                    ...
                    <p style="font-size: 25px; font-weight: 200;">Hi Admin, Welcome in Edit Data Bahan Baku!</p>
                </div>
                <div class="col-7">
                    <div class="profile">
            ...
            <div class="container mt-4 mb-5">
                <form action="{{ route('update_BahanBaku', $bahanbaku) }}" method="POST">
                    @method('patch')
                    @csrf
                    <div class="row">

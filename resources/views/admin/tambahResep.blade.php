            ...
            <div class="container mt-4 mb-3">
                <div class="row">
                    <div class="title mt-5 mb-3">
                        <h5 style="font-size: 40px; font-weight: 600;">Tambah Resep</h5>
                        <p style="font-size: 20px; font-weight: 300">Tingkatkan kreativitasmu di dapur! </p>
                    </div>
                    <div class="col-12">
                        <form id="resepForm" method="POST" action="{{ route('tambahResep') }}">
                            @csrf
                            <div class="label">
                                ...
                                <div class="ingredient-input">
                                    <!-- Input bahan baku akan ditambahkan di sini -->
                                </div>
                            ...
                            <div style="text-align: center;" class="mb-5 mt-5">
                                <button type="submit" onclick="submitForm()" class="btn btn-key">Tambah Resep</button>
                            </div>
                        </form>
                    </div>
                </div>

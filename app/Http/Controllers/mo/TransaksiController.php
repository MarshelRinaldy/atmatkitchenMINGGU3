...
class TransaksiController extends Controller
{
    ...
    //     return view('mo.pesanan.pesanan', compact('transaksis'));
    // }
    ...
    //         }
    //         if (count($error) > 0) {
    //             return redirect()->route('mo.pesanan')->with('error', $error);
    //         }
    ...
    //         return redirect()->route('mo.pesanan')->with('success', 'Pesanan berhasil diterima dan segera di proses');
    //     }
    // }
    ...
    public function pesanan_accept(Request $request)
    {
        ...
        foreach ($request->trans_id as $id) {
            ...
            $pembelian = $transaksi->jumlah_transaksi;
            $poin = 0;
            if ($pembelian >= 1000000) {
                $poin += intdiv($pembelian, 1000000) * 200;
                $pembelian %= 1000000;
